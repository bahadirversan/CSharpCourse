...
namespace EntityFrameworkDemo
{
    public partial class Form1 : Form
    {
        ...
        {
            dgwProducts.DataSource = _productDal.GetAll();//ürünleri yeniden yükleme
        }

        private void SearchProducts(string key)//arama kısmına yazdığımız harf ya da harflerle ürün eşleştirmesi
        {
            //var result = _productDal.GetAll().Where(p => p.Name.ToLower().Contains(key.ToLower())).ToList();//ToLower küçük harfle de arama yapma olanağı sağlar
